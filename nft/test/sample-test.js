...
describe("NFTMarket", function() {
  it("Should create and execute market sales", async function() {
    ...
    /* create two tokens */
    await nftMarketplace.createToken("http://zhangys.org.cn", auctionPrice, { value: listingPrice })
    await nftMarketplace.createToken("http://brahma.pub", auctionPrice, { value: listingPrice })
